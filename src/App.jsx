...
function TheDiet4ULanding() {
  ...
  return (
    <div className="min-h-screen w-screen bg-gradient-to-br from-green-50 to-orange-50 flex flex-col justify-between">
      {/* Navigation */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link to="/" className="text-black hover:text-green-600 font-medium transition-colors">Home</Link>
              <Link to="/programs" className="text-black hover:text-green-600 font-medium transition-colors">Our Programs</Link>
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-white border-t">
              <div className="px-2 pt-2 pb-3 space-y-1">
                <Link to="/" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-gray-700 hover:text-green-600 font-medium">Home</Link>
                <Link to="/programs" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-gray-700 hover:text-green-600 font-medium">Our Programs</Link>
                <Link to="/about" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-gray-700 hover:text-green-600 font-medium">About</Link>
                <button onClick={() => { setIsMenuOpen(false); navigate("/contact"); }} className="w-full text-left bg-green-600 text-white px-3 py-2 rounded-lg hover:bg-green-700 transition-colors font-medium mt-2">Reach us</button>
              </div>
            </div>
          )}
        </div>
      ...
      <section className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <h2 className="text-2xl lg:text-3xl font-semibold text-orange-600">Your Path to a Healthier You</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8">
              <div className="flex items-center space-x-3"><Heart className="h-6 w-6 text-red-500" /><span className="text-gray-700 font-medium">Heart Healthy</span></div>
              <div className="flex items-center space-x-3"><Target className="h-6 w-6 text-green-500" /><span className="text-gray-700 font-medium">Goal Focused</span></div>
              <div className="flex items-center space-x-3"><Users className="h-6 w-6 text-blue-500" /><span className="text-gray-700 font-medium">Expert Support</span></div>
            </div>
          </div>
